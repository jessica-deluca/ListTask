...
namespace ListTask.Controllers
{
    ...
    {
        private ListTaskContext db = new ListTaskContext();
        ...
        public ActionResult Create([Bind(Include = "TaskID,TaskDescription,TaskIsDone,TaskDueDate,ListID")] Task task)
        {
            ...
            ViewBag.ListID = new SelectList(db.Lists, "ListID", "ListTitle", task.ListID);
            return View(task);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TaskID,TaskDescription,TaskIsDone,TaskDueDate,ListID")] Task task)
        {
            if (ModelState.IsValid)
            {
